                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="footer-widget footer-social">
                            ...
                            <ul class="listnone">
                                ...
                                <li><a href="https://shorturl.at/bdgH2"><i class="fa fa-google-plus"></i> Google Plus</a></li>
                                <li><a href="https://in.linkedin.com/"><i class="fa fa-linkedin"></i> Linked In</a></li>
                                <li>
                                    <a href="https://www.youtube.com/watch?v=Dh4dVNZGcz8"> <i class="fa fa-youtube"></i>Youtube</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.social block -->
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© Men Salon Management System 2023</p>
                            </div>
                        </div>
                    </div>
                </div>
