                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div >
                        <center>
                            <br>
                            <br>
                        <h2 style="font-size:50px">Book Appointment</h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> near kbn college , onetwon , vijayawada , 520001 </li>
                                <li><i class="fa fa-phone"></i> +91 7989859469</li>
                                <li><i class="fa fa-fax"></i> +91 7989859469</li>
                                <li><i class="fa fa-envelope-o"></i> techsalon@salon.com</li>
                            </ul>
                        </div>
                    </div>
